...
[![Build Status](https://travis-ci.org/gjb2048/moodle-format_collblct.svg?branch=MOODLE_35)](https://travis-ci.org/gjb2048/moodle-format_collblct)
...
The secondary source is a tagged version with the v3.5 prefix on https://github.com/gjb2048/moodle-format_collblct/tags
...
Documented on http://docs.moodle.org/35/en/Collapsed_Topics_course_format
...
release area is located on https://moodle.org/plugins/view.php?plugin=format_collblct.  It is also essential that you are
...
on Moodle tracker 'tracker.moodle.org' ensuring that you chose the 'Non-core contributed modules' and 'Course Format: collblct'
