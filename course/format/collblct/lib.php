...
class format_collblct extends format_base {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            ...
            $defaulttgfgcolour = get_config('format_collblct', 'defaulttgfgcolour');
            if ($defaulttgfgcolour[0] == '#') {
                $defaulttgfgcolour = substr($defaulttgfgcolour, 1);
            }
            $defaulttgfghvrcolour = get_config('format_collblct', 'defaulttgfghvrcolour');
            if ($defaulttgfghvrcolour[0] == '#') {
                $defaulttgfghvrcolour = substr($defaulttgfghvrcolour, 1);
            }
            $defaulttgbgcolour = get_config('format_collblct', 'defaulttgbgcolour');
            if ($defaulttgbgcolour[0] == '#') {
                $defaulttgbgcolour = substr($defaulttgbgcolour, 1);
            }
            $defaulttgbghvrcolour = get_config('format_collblct', 'defaulttgbghvrcolour');
            ...
            $courseformatoptions = array(
                ...
                'displayinstructions' => array(
                    'default' => get_config('format_collblct', 'defaultdisplayinstructions'),
                    'type' => PARAM_INT,
                ),
                'layoutelement' => array(
                    'default' => get_config('format_collblct', 'defaultlayoutelement'),
                    'type' => PARAM_INT,
                ),
                'layoutstructure' => array(
                    'default' => get_config('format_collblct', 'defaultlayoutstructure'),
                    'type' => PARAM_INT,
                ),
                'layoutcolumns' => array(
                    'default' => get_config('format_collblct', 'defaultlayoutcolumns'),
                    'type' => PARAM_INT,
                ),
                ...
                'toggleiconposition' => array(
                    'default' => get_config('format_collblct', 'defaulttoggleiconposition'),
                    'type' => PARAM_INT,
                ),
                'toggleiconset' => array(
                    'default' => get_config('format_collblct', 'defaulttoggleiconset'),
                    'type' => PARAM_ALPHA,
                ),
                'onesection' => array(
                    'default' => get_config('format_collblct', 'defaultonesection'),
                    'type' => PARAM_INT,
                ),
                'toggleallhover' => array(
                    'default' => get_config('format_collblct', 'defaulttoggleallhover'),
                    'type' => PARAM_INT,
                ),
                ...
                'toggleforegroundopacity' => array(
                    'default' => get_config('format_collblct', 'defaulttgfgopacity'),
                    'type' => PARAM_RAW,
                ),
                ...
                'toggleforegroundhoveropacity' => array(
                    'default' => get_config('format_collblct', 'defaulttgbghvropacity'),
                    'type' => PARAM_RAW,
                ),
                ...
                'togglebackgroundopacity' => array(
                    'default' => get_config('format_collblct', 'defaulttgbgopacity'),
                    'type' => PARAM_RAW,
                ),
                ...
                'showsectionsummary' => array(
                    'default' => get_config('format_collblct', 'defaultshowsectionsummary'),
                    'type' => PARAM_INT,
                )
            );
        }
        if ($foreditform && !isset($courseformatoptions['displayinstructions']['label'])) {
            ...
            if (has_capability('format/collblct:changelayout', $context)) {
                ...
                $courseformatoptionsedit['layoutcolumns'] = array(
                    ...
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(1 => new lang_string('one', 'format_collblct'),   // Default.
                ...
                $courseformatoptionsedit['layoutcolumnorientation'] = array(
                    ...
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(1 => new lang_string('columnvertical', 'format_collblct'),
                ...
                $courseformatoptionsedit['toggleiconposition'] = array(
                    ...
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(1 => new lang_string('left', 'format_collblct'),   // Left.
                ...
                $courseformatoptionsedit['layoutelement'] = array(
                    'label' => get_config('format_collblct', 'defaultlayoutelement'), 'element_type' => 'hidden');
                $courseformatoptionsedit['layoutstructure'] = array(
                    'label' => get_config('format_collblct', 'defaultlayoutstructure'), 'element_type' => 'hidden');
                $courseformatoptionsedit['layoutcolumns'] = array(
                ...
                $courseformatoptionsedit['onesection'] = array(
                    'label' => get_config('format_collblct', 'defaultonesection'), 'element_type' => 'hidden');
                $courseformatoptionsedit['showsectionsummary'] = array(
                    'label' => get_config('format_collblct', 'defaultshowsectionsummary'), 'element_type' => 'hidden');
            }
            ...
            if (has_capability('format/collblct:changetoggleiconset', $context)) {
                ...
                $courseformatoptionsedit['toggleiconset'] = array(
                    'label' => get_config('format_collblct', 'defaulttoggleiconset'), 'element_type' => 'hidden');
                $courseformatoptionsedit['toggleallhover'] = array(
                    'label' => get_config('format_collblct', 'defaulttoggleallhover'), 'element_type' => 'hidden');
            }
    ...
    public function create_edit_form_elements(&$mform, $forsection = false) {
        ...
        MoodleQuickForm::registerElementType('tccolourpopup', "$CFG->dirroot/course/format/collblct/js/tc_colourpopup.php",
        ...
        if ($bsfour) {
            ...
            $checkboxname = get_string('resetdisplayinstructions', 'format_collblct').
                $OUTPUT->help_icon('resetdisplayinstructions', 'format_collblct');
            $resetelements[] =& $mform->createElement('checkbox', 'resetdisplayinstructions', '', $checkboxname);
        }
        ...
        if ($changelayout) {
            if ($bsfour) {
                ...
                $checkboxname = get_string('resetlayout', 'format_collblct').$OUTPUT->help_icon('resetlayout', 'format_collblct');
                $resetelements[] =& $mform->createElement('checkbox', 'resetlayout', '', $checkboxname);
            }
        }
        ...
        if ($changecolour) {
            if ($bsfour) {
                ...
                $checkboxname = get_string('resetcolour', 'format_collblct').$OUTPUT->help_icon('resetcolour', 'format_collblct');
                $resetelements[] =& $mform->createElement('checkbox', 'resetcolour', '', $checkboxname);
            }
        }
        ...
        if ($changetogglealignment) {
            if ($bsfour) {
                ...
                $checkboxname = get_string('resettogglealignment', 'format_collblct').
                    $OUTPUT->help_icon('resettogglealignment', 'format_collblct');
                $resetelements[] =& $mform->createElement('checkbox', 'resettogglealignment', '', $checkboxname);
            }
        }
        ...
        if ($changetoggleiconset) {
            if ($bsfour) {
                ...
                $checkboxname = get_string('resettoggleiconset', 'format_collblct').
                    $OUTPUT->help_icon('resettoggleiconset', 'format_collblct');
                $resetelements[] =& $mform->createElement('checkbox', 'resettoggleiconset', '', $checkboxname);
            }
        }
        ...
        if ($resetall) {
            ...
            if ($bsfour) {
                ...
                $checkboxname = get_string('resetalldisplayinstructions', 'format_collblct').
                    $OUTPUT->help_icon('resetalldisplayinstructions', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalldisplayinstructions', '', $checkboxname);

                $checkboxname = get_string('resetalllayout', 'format_collblct').
                    $OUTPUT->help_icon('resetalllayout', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalllayout', '', $checkboxname);

                $checkboxname = get_string('resetallcolour', 'format_collblct').
                    $OUTPUT->help_icon('resetallcolour', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetallcolour', '', $checkboxname);

                $checkboxname = get_string('resetalltogglealignment', 'format_collblct').
                    $OUTPUT->help_icon('resetalltogglealignment', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalltogglealignment', '', $checkboxname);

                $checkboxname = get_string('resetalltoggleiconset', 'format_collblct').
                    $OUTPUT->help_icon('resetalltoggleiconset', 'format_collblct');
                $resetallelements[] =& $mform->createElement('checkbox', 'resetalltoggleiconset', '', $checkboxname);
            }
    ...
    public function reset_collblct_setting($courseid, $displayinstructions, $layout, $colour, $togglealignment, $toggleiconset) {
        ...
        if ($displayinstructions && $resetallifall) {
            $updatedata['displayinstructions'] = get_config('format_collblct', 'defaultdisplayinstructions');
            $updatedisplayinstructions = true;
        }
        if ($layout && has_capability('format/collblct:changelayout', $context) && $resetallifall) {
            $updatedata['layoutelement'] = get_config('format_collblct', 'defaultlayoutelement');
        ...
        if ($togglealignment && has_capability('format/collblct:changetogglealignment', $context) && $resetallifall) {
            $updatedata['togglealignment'] = get_config('format_collblct', 'defaulttogglealignment');
            $updatetogglealignment = true;
        }
        if ($colour && has_capability('format/collblct:changecolour', $context) && $resetallifall) {
            $updatedata['toggleforegroundcolour'] = get_config('format_collblct', 'defaulttgfgcolour');
            $updatedata['toggleforegroundopacity'] = get_config('format_collblct', 'defaulttgfgopacity');
            $updatedata['toggleforegroundhovercolour'] = get_config('format_collblct', 'defaulttgfghvrcolour');
            $updatedata['toggleforegroundhoveropacity'] = get_config('format_collblct', 'defaulttgfghvropacity');
            $updatedata['togglebackgroundcolour'] = get_config('format_collblct', 'defaulttgbgcolour');
            $updatedata['togglebackgroundopacity'] = get_config('format_collblct', 'defaulttgbgopacity');
            $updatedata['togglebackgroundhovercolour'] = get_config('format_collblct', 'defaulttgbghvrcolour');
            $updatedata['togglebackgroundhoveropacity'] = get_config('format_collblct', 'defaulttgbghvropacity');
            $updatecolour = true;
        }
        if ($toggleiconset && has_capability('format/collblct:changetoggleiconset', $context) && $resetallifall) {
            $updatedata['toggleiconset'] = get_config('format_collblct', 'defaulttoggleiconset');
            $updatedata['toggleallhover'] = get_config('format_collblct', 'defaulttoggleallhover');
    ...
    public function restore_collblct_setting($courseid, $layoutelement, $layoutstructure, $layoutcolumns, $tgfgcolour,
        ...
        if (empty($lco)) {
            ...
            $data['toggleiconposition'] = get_config('format_collblct', 'defaulttoggleiconposition');
            $data['toggleiconset'] = get_config('format_collblct', 'defaulttoggleiconset');
        }
