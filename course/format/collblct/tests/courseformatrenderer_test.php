 ...
 */
class format_collblct_courseformatrenderer_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->course = $this->getDataGenerator()->create_course(array('format' => 'collblct', 'numsections' => 1),
    ...
    public function test_display_instructions() {
        ...
        $thevalue = '<li class="tcsection main clearfix" id="collblct-display-instructions"><div class="left side">';
        ...
        $thevalue .= '<img class="icon spacer" width="1" height="1" alt="" src="';
        $thevalue .= $CFG->wwwroot.'/theme/image.php/_s/clean/core/1/spacer" /></div><div class="content">';
        $thevalue .= '<div class="sectionbody"><p class="collblct-display-instructions">Instructions: Clicking on the section ';
